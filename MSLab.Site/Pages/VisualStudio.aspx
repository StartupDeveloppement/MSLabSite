...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label runat="server" Text="Visual Studio possède des numéros de version qu'il faut connaitre : "></asp:Label>
    <asp:Label runat="server" Text="Visual Studio 2010 à la version 10"></asp:Label>
    <asp:Label runat="server" Text="Visual Studio 2012 à la version 12"></asp:Label>
    <asp:Label runat="server" Text="Visual Studio 2013 à la version 13"></asp:Label>
    <asp:Label runat="server" Text="Visual Studio 2015 à la version 14"></asp:Label>
