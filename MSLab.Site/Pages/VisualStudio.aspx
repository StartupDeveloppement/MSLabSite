...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label runat="server" CssClass="LabSitePageTitle2" ID="TitleInstallation" Text="Téléchargement & Installation" />
    <asp:Panel runat="server" ID="ContentInstallation">
        <asp:Label runat="server" CssClass="LabSitePageTitle2" Text=""></asp:Label>
        <br />
    ...
    <br />
    <asp:Label runat="server" CssClass="LabSitePageTitle2" ID="TitleExtensions" Text="Extensions" />
    <asp:Panel runat="server" ID="ContentExtensions">
    ...
    <ajaxToolkit:CollapsiblePanelExtender runat="server" ID="CollapsiblePanelExtender1"
        TargetControlID="ContentExtensions"
        AutoCollapse="False"
        AutoExpand="False"
        ScrollContents="True"
        Collapsed="True"
        CollapseControlID="TitleExtensions"
        ExpandControlID="TitleExtensions" />
</asp:Content>
