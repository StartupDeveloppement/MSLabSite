...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label runat="server" Text="GitBash est un outil en ligne de commande qui remplace TortoiseGit, il ne faut JAMAIS utiliser les deux outils en parallèle."></asp:Label>
    <asp:Label runat="server" Text="Double clic dans le repo puis Git Bash :"></asp:Label>
